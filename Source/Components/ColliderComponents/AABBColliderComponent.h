...
private:
    ...
    void ResolveHorizontalCollisions(RigidBodyComponent *rigidBody, const float minXOverlap);
    void ResolveVerticalCollisions(RigidBodyComponent *rigidBody, const float minYOverlap);
