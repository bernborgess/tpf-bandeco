...
CircleColliderComponent::CircleColliderComponent(class Actor* owner,
                                                 const float radius,
                                                 const int updateOrder)
    : Component(owner, updateOrder), mRadius(radius) {}
...
bool CircleColliderComponent::Intersect(
    const CircleColliderComponent& c) const {
